...
import Data from "../src/Api/MoviesSectionData/MovieSelfImprovement.json";
import './Movie.css';
          ...
          <div className="Movie-slider-container">
            <div className="Movie-slider-track">
              {filteredMovies.map((currElem) => {
                const { title, language, summary, duration, poster, rating, trailer, youtubeTrailer } = currElem;
                const isInWishlist = wishlist.some((item) => item.title === title);
                // Use youtubeTrailer if trailer is not available
                const movieTrailer = trailer || youtubeTrailer;
