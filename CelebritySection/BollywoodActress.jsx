import './Wishlist.css'
import ActressPhotos from '../src/Api/WishlistSectionData/ActressPhotos.json';
import ActressMovies from '../src/Api/WishlistSectionData/ActressData1.json';

import React, { useState, useEffect, useRef } from "react";
const BollywoodActress = () =>
{
  ...
  const filteredMovies = selectedActress
    ...
    return(
      ...
      <h1 onClick={() => setSelectedActress(null)} style={{ cursor: "pointer" }}>Bollywood Actress</h1>
