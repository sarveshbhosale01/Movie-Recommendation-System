import './Wishlist.css'
import ActorPhotos from '../src/Api/WishlistSectionData/ActorPhotosH.json';
import ActionMovies from '../src/Api/WishlistSectionData/ActorDataH.json';
import React, { useState, useEffect, useRef } from "react";
const HollywoodActor = () =>
{
  ...
  const filteredMovies = selectedActor
    ...
    return(
      ...
      <h1 onClick={() => setSelectedActor(null)} style={{ cursor: "pointer" }}>Hollywood Actors</h1>
